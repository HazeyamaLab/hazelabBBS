...
--
-- Host: localhost    Database: hazelabBBS
-- ------------------------------------------------------
...
CREATE TABLE `posts` (
  ...
  KEY `bbs_id` (`bbs_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`bbs_id`) REFERENCES `bbs` (`id`),
...
INSERT INTO `users` VALUES ('admin','admin','mallow'),('haze','haze','mallow');
...
-- Dump completed on 2018-05-29  9:06:44
